...
spacex_df = pd.read_csv(r"C:\Users\art\Documents\spacex\coursera-ibm-spacex\space_launch_dash.csv")
...
def update_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        df = filtered_df['class'].value_counts().rename_axis('class').reset_index(name='count')
